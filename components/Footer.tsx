    ...
    <footer className="wrap mt-16 space-y-1.5 pb-16 text-[13px] text-mute sm:mt-22">
      <p className={stale ? "text-[var(--neg)]" : undefined}>
        {stats
          ...
          : "No live data"}{" "}
        · price &amp; volume from DexScreener, chart data from GeckoTerminal,
        status &amp; launch data from stonkfun.xyz, round &amp; lock data from
        stonk5.com&apos;s own engine, burns &amp; authorities verified
        on-chain.
      </p>
      <p>
        <a
