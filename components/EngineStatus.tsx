...
export default function EngineStatus({
  ...
  return (
    <div className="rounded-xl border border-navy-700 bg-navy-800/60 p-5">
      ...
      <div className="mt-2 flex items-baseline justify-between font-mono text-sm text-navy-100">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 border-t border-navy-700 pt-4">
        <div>
          <div className="font-mono text-lg text-navy-50">
