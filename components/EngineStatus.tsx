...
export default function EngineStatus({
  ...
  return (
    <div className="rounded-2xl border border-navy-150 bg-white p-6 shadow-card">
      ...
      <div className="mt-2.5 flex items-baseline justify-between font-mono text-sm tabular-nums text-navy-800">
      ...
      <p className="mt-2.5 text-xs leading-relaxed text-navy-500">
        Fees toward the next buy-basket-and-burn round (5 SOL, or every 5h,
        whichever comes first).
      </p>

      <div className="mt-5 grid grid-cols-2 gap-4 border-t border-navy-150 pt-4">
        <div>
          <div className="font-mono text-lg tabular-nums text-navy-900">
